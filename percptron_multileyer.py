...
n_input = 3 #quantos valores de entrada?
...
train_X, train_Y = data_encode("train01.train") #dataset de treinamento
test_X, test_Y = data_encode("selecao.test") #dataset de validacao
